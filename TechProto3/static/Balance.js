...
var display_video = function(num)
{
    ...
    $.each(Balance, function(i, value){
        ...
        //var row = $("<div class = 'row bottom_row_padding'>")
                ...
                //$(col_entry).append("<div id='name'> "+Balance[i]['name']+"</div>");
                //$(row).append(col_entry)
                console.log(Balance[i])
                console.log(Balance[i]['benefits'])
                console.log(Balance[i]['name'])
                //var col_entry = $("<div class = 'col-md-3'>")
                
                 $(col_entry).append("<div class = 'vid-container' <span id='"+Balance[i]["video_link"]+"'> <span id ='name'>"+Balance[i]['name']+"</span></span> <iframe class='video' id = '"+Balance[i]["benefits"]+"' width='150' height='100' src='https://www.youtube.com/embed/?playlist="+Balance[i]["video_link"]+"'></iframe> <button class ='btn btn-outline-secondary select_button " + item + "'>select</button></div>")
                 //$(row).append(col_entry)
