...
var display_video = function(num)
{
    ...
    $.each(Stretch2, function(i, value){
        ...
        //var row = $("<div class = 'row bottom_row_padding'>")
                ...
                //$(col_entry).append("<div id='name'> "+Stretch2[i]['name']+"</div>");
                //$(row).append(col_entry)
                console.log(Stretch2[i])
                console.log(Stretch2[i]['benefits'])
                console.log(Stretch2[i]['name'])
                //var col_entry = $("<div class = 'col-md-3'>")
                
                 $(col_entry).append("<div class = 'vid-container' <span id='"+Stretch2[i]["video_link"]+"'> <span id ='name'>"+Stretch2[i]['name']+"</span></span> <iframe class='video' id = '"+Stretch2[i]["benefits"]+"' width='150' height='100' src='https://www.youtube.com/embed/?playlist="+Stretch2[i]["video_link"]+"'></iframe> <button class ='btn btn-outline-secondary select_button " + item + "'>select</button></div>")
                 //$(row).append(col_entry)
