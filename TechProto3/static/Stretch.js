...
var display_video = function(num)
{
    ...
    $.each(Stretch1, function(i, value){
        ...
        //var row = $("<div class = 'row bottom_row_padding'>")
                ...
                //$(col_entry).append("<div id='name'> "+Stretch1[i]['name']+"</div>");
                //$(row).append(col_entry)
                console.log(Stretch1[i])
                console.log(Stretch1[i]['benefits'])
                console.log(Stretch1[i]['name'])
                //var col_entry = $("<div class = 'col-md-3'>")
                
                 $(col_entry).append("<div class = 'vid-container' <span id='"+Stretch1[i]["video_link"]+"'> <span id ='name'>"+Stretch1[i]['name']+"</span></span> <iframe class='video' id = '"+Stretch1[i]["benefits"]+"' width='150' height='100' src='https://www.youtube.com/embed/?playlist="+Stretch1[i]["video_link"]+"'></iframe> <button class ='btn btn-outline-secondary select_button " + item + "'>select</button></div>")
                 //$(row).append(col_entry)
